...
Existing apps like Fuelio, CarDiary, and CarSpending come close but not close enough — Gaspense is a self-built alternative for tracking the *real* total cost of vehicle ownership in one place, with proper reporting (cost per month/year) instead of scattered receipts. The core first-use moment: add a car, log a fuel fill-up.
